...
const createQueryClient = (tmClient: Tendermint37Client, rpcClient: Rpc) => {
...
type DemexQueryClient = ReturnType<typeof createQueryClient>;
namespace DemexQueryClient {
  export const instance = (opts: DemexQueryClientOpts) => {
    ...
    return createQueryClient(opts.tmClient, rpcClient);
  }
}
