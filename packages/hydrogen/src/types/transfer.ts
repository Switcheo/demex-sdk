import { PaginatedResult } from "./misc";
import { GetRelaysResponse } from "./relays";
...
export interface GetTransfersResponse extends PaginatedResult<CrossChainTransfer> {
}
...
export interface CrossChainTransfer {
  ...
  source_blockchain: string | null;
  from_chain_id: number;
  bridging_blockchain: string | null;
  bridge_id: number;
  destination_blockchain: string | null;
  to_chain_id: number;
