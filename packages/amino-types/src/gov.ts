...
import { MsgUpdateParams as MsgAuthUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/auth/v1beta1/tx.js";
import { MsgUpdateParams as MsgBankUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/bank/v1beta1/tx.js";
import { CommunityPoolSpendProposal } from "@demex-sdk/codecs/src/data/cosmos/distribution/v1beta1/distribution.js";
import { MsgCommunityPoolSpend, MsgUpdateParams as MsgDistributionUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/distribution/v1beta1/tx.js";
import { MsgExecLegacyContent, MsgUpdateParams as MsgGovUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/gov/v1/tx.js";
import { TextProposal } from "@demex-sdk/codecs/src/data/cosmos/gov/v1beta1/gov.js";
import { ParameterChangeProposal } from "@demex-sdk/codecs/src/data/cosmos/params/v1beta1/params.js";
import { MsgUpdateParams as MsgSlashingUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/slashing/v1beta1/tx.js";
import { MsgUpdateParams as MsgStakingUpdateParams } from "@demex-sdk/codecs/src/data/cosmos/staking/v1beta1/tx.js";
import { MsgCancelUpgrade, MsgSoftwareUpgrade } from "@demex-sdk/codecs/src/data/cosmos/upgrade/v1beta1/tx.js";
import { CancelSoftwareUpgradeProposal, SoftwareUpgradeProposal } from "@demex-sdk/codecs/src/data/cosmos/upgrade/v1beta1/upgrade.js";
import { Any } from "@demex-sdk/codecs/src/data/google/protobuf/any.js";
import { ClientUpdateProposal } from "@demex-sdk/codecs/src/data/ibc/core/client/v1/client.js";
import { MsgRemoveMinGasPrice } from "@demex-sdk/codecs/src/data/Switcheo/carbon/fee/tx.js";
import { MsgUpdateParams as MsgOracleUpdateParams } from "@demex-sdk/codecs/src/data/Switcheo/carbon/oracle/tx.js";
...
export const decodeContent = (content?: Any): PropDecoded => {
  ...
  if (url == TxTypes.MsgGovExecLegacyContent) {
